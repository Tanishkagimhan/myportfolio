      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          >
            ...
            >
              As I seek an opportunity as a Software Engineering Intern, I aim to apply my skills and enthusiasm to gain hands-on experience in the IT field. I am dedicated to contributing effectively to projects while continuing to expand my understanding of software development and technology.
            </motion.p>
